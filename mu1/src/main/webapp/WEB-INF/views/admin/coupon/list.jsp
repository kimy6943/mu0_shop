			...
			<div>
				<table class="coupon_list" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>2021-05-02</td>
						<td><button id="wBtn"
								onclick="location.href='coupon_write'">수정</button></td>
					</tr>
					<tr>
						<td>2</td>
						<td>기분이다 8,888쿠폰</td>
				...
				<div class="admin_toll">
					<ul>
						<li>
							<button id="wBtn" onclick="window.open('coupon_write.do','window_name','width=800,height=600,location=no,status=no,scrollbars=yes');">쿠폰생성</button>
               			</li>
					</ul>
				</div>
